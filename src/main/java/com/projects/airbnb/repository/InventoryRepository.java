...
public interface InventoryRepository extends JpaRepository<Inventory,Long> {
    ...
    //(i.totalCount - i.bookedCount) >= :numberOfRooms--this below ensures that for e.g. some other customer booked
    //rooms, so we must make sure that we do not oversell the rooms
    @Modifying
    @Query("""
                UPDATE Inventory i
                SET i.reservedCount = i.reservedCount - :numberOfRooms,
